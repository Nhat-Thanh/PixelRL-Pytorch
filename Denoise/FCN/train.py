...
from model import PixelWiseA3C 
...
PRETRAINED_PATH = os.path.join(PRETRAINED_DIR, "FCN/denoise_{}.pt".format(SIGMA))
...
def main():
    ...
    pixelRL = PixelWiseA3C(MODEL, T_MAX, GAMMA, BETA)
    pixelRL.setup(OPTIMIZER, BATCH_SIZE, PSNR,  DEVICE, MODEL_PATH, CKPT_PATH)
